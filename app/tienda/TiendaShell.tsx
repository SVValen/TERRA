...
export default function TiendaShell({ children, nombre, logoUrl, whatsapp }: Props) {
  return (
        ...
        <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-sm border-b border-stone-200 shadow-sm">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <Link href="/tienda" className="flex items-center gap-3">
              ...
              <span className="font-semibold text-stone-900 text-lg tracking-tight">{nombre}</span>
            </Link>
